...
De los modelos más simples (de 1 capa) vamos a elegir el de 128 unidades y learning rate 0.01 con 50 epochs, ya que dentro de los modelos simples tener 128 unidades no supone mucho más costo computacional que tener 64 o 32, y el resultado de 50 epochs no está muy por debajo que el de 100 epochs.
```{r}
# Seleccionamos el mejor modelo
best <- best[best$units == 128 & best$lr == 0.01 & best$epochs == 50, ]
```
