...
# Convertir los valores de y a formato one-hot sin usar to_categorical de keras
to_one_hot <- function(y, num_classes) {
    y <- as.integer(y)
    n <- length(y)
    one_hot <- matrix(0, n, num_classes)
    one_hot[cbind(1:n, y + 1)] <- 1
    return(one_hot)
}
