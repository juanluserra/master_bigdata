...
Auto <- read.csv("~/matematicas/aprendizaje estadistico/GEMA 24_25/primera semana/Auto.csv")
...
### summary te da las medidas tÃ­picas de posiciÃ³n de la EstadÃ­stica Descriptiva
...
## num = numeric
## int = integer
## factor = cualitativas=datos categÃ³ricos (variables que puedan servir para clasificar).
## logical = V o F.
